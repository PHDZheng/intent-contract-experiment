...
reg "lineage manifest step: input is output_dir" round-1 manifest integration "Lineage manifest step" "lineage manifest step: input is output_dir"
...
reg "lineage manifest step: edge from output_dir" round-1 manifest integration "Lineage manifest step" "lineage manifest step: edge from output_dir"
reg "lineage manifest step: edge to manifest.json" round-1 manifest integration "Lineage manifest step" "lineage manifest step: edge to manifest.json"
...
_emit_case() {
  ...
  local origin="${CASE_ORIGIN[$name]:-round-5}"
...
EOF
  ...
  # Edge from output_dir to manifest.json
  ...
  check "lineage manifest step: edge from output_dir" "output_dir" "$EDGE_FROM"
  check "lineage manifest step: edge to manifest.json" "manifest.json" "$EDGE_TO"
else
  skip "lineage manifest step: input is output_dir"
  skip "lineage manifest step: output is manifest.json"
  skip "lineage manifest step: edge from output_dir"
  skip "lineage manifest step: edge to manifest.json"
fi
